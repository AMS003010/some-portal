            ...
            <div className='sidebar fixed z-10 top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-64 h-dvh overflow-y-auto text-center bg-gradient-to-r from-[#170a4b] to-[#12073a] transform transition duration-300'>
                <div>
                    ...
                    <div className='flex flex-col justify-start mt-10'>
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#FFF] hover:text-white  pl-3 cursor-pointer' onClick={() => setIndex(0)}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-7 h-7">
                        ...
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#FFF] hover:text-white pl-3 cursor-pointer' onClick={() => setIndex(3)}>
                            ...
                            <span className={`${nunito.className} text-lg ml-2`}>Compare</span>
                        </div>
