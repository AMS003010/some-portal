        ...
        <>
            ...
            <div className='sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-64 overflow-y-auto text-center bg-gradient-to-r from-[#170a4b] to-[#12073a]'>
                <div>
                    ...
                    <hr className=' flex justify-center border-t-2 border-[#6867c4] mt-4'/>
                    <div className='flex flex-col justify-start mt-10'>
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#6867c4] hover:text-white  pl-3 cursor-pointer'>
                        ...
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#6867c4] hover:text-white pl-3 cursor-pointer'>
                            ...
                            <span className={`${nunito.className} text-lg ml-2`}>Authors</span>
                        </div>
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#6867c4] hover:text-white pl-3 cursor-pointer'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-7 h-7">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                            </svg>
                            <span className={`${nunito.className} text-lg ml-2`}>Publications</span>
                        </div>
                        <div className='flex justify-start items-center my-1 hover:bg-[#21205e] rounded-lg py-4 text-[#6867c4] hover:text-white pl-3 cursor-pointer absolute bottom-2 w-[94%]'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-7 h-7">
