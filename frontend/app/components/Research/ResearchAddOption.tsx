...
import AddJournal from './Add/Journal_Add';
import AddConference from './Add/Conference_Add';
import AddPatent from './Add/Patent_Add';
import AddGrant from './Add/Grant_Add';
import AddSupport from './Add/Support_Add';
import AddAwards from './Add/Awards_Add';
...
export default function ResearchAddOption () {
    ...
    return(
        <div className="bg-[#d5e7eb] h-[100vh] w-screen flex justify-end overflow-y-auto">
            <div className="h-max bg-white m-3 w-[94%] md:w-[79%] rounded-2xl text-gray-500 p-7 flex flex-col shadow">
                ...
                <h1 className={`${roboto.className} text-black text-3xl md:text-4xl lg:text-4xl mt-16 md:mt-7`}>Research / Add</h1>
