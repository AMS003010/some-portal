                ...
                <form>
                    <div className='flex justify-between gap-5 mb-7'>
                        ...
                        <div className='relative w-full'>
                            ...
                            <select name="capstone" id="capstone" className='text-gray-400 text-lg outline-none pb-3 pr-[10%] lg:pr-[71%] focus:text-rose-400'>
                                <option value="type">Type</option>
                                <option value="">Journal</option>
                                <option value="published">Conference</option>
                                <option value="published">Book Chapter</option>
                            </select>
                    ...
                    <div className='lg:flex justify-between gap-5 lg:mb-7'>
                        <div className='relative w-full'>
                            <input 
                                className='peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-400' 
                                type='text'
                        ...
                        <div className='relative w-full'>
                            ...
                            <select name="Status" id="status" className='text-gray-400 text-lg outline-none pb-3 pr-[77%] focus:text-rose-400'>
                    ...
                    <div className='flex justify-between gap-5 mb-7'>
                        <div className='relative w-full'>
                            ...
                            <select name="capstone" id="capstone" className='text-gray-400 text-lg outline-none pb-3 pr-[48%] focus:text-rose-400'>
                                <option value="status">Capstone Project ( Yes / No )</option>
                    ...
                    <button type='submit' className='w-full text-red-500 text-2xl font-bold border-red-500 border-solid border-2 p-3 rounded-lg flex items-center justify-center hover:bg-red-300 hover:text-white hover:border-white'>Submit</button>
                </form>
            </div>
        </div>
    )
