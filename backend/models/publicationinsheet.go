...
type PublicationinSheet struct {
	ID                      string `json:"ID" db:"ID"`
	FacultyName             string `json:"FacultyName" db:"Name of the faculties in PES University (Currently)"`
	StartDate               string `json:"StartDate" db:"Publication / Conference Start Date"`
	EndDate                 string `json:"EndDate" db:"End Date"`
	...
	IsCapstone              string `json:"IsCapstone" db:"Capstone/ Non Capstone"`
